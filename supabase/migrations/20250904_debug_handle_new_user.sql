-- Debug: Add logging to handle_new_user function to identify the registration error
-- Date: 2025-09-04
-- Description: Temporarily add debug logging to see what's causing the registration failure

-- Replace the handle_new_user function with a debug version
